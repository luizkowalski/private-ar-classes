...
class RuboCop::Cop::Style::InverseMethods < ::RuboCop::Cop::Base
  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#70
  def inverse_block?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#61
  def inverse_candidate?(param0 = T.unsafe(nil)); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#91
  def on_block(node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#91
  def on_numblock(node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#78
  def on_send(node); end

  private

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#176
  def camel_case_constant?(node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#120
  def correct_inverse_block(corrector, node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#111
  def correct_inverse_method(corrector, node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#127
  def correct_inverse_selector(block, corrector); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#180
  def dot_range(loc); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#163
  def end_parentheses(node, method_call); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#149
  def inverse_blocks; end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#144
  def inverse_methods; end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#190
  def message(method, inverse); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#153
  def negated?(node); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#157
  def not_to_receiver(node, method_call); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#171
  def possible_class_hierarchy_check?(lhs, rhs, method); end

  # source://rubocop/1.56.2/lib/rubocop/cop/style/inverse_methods.rb#184
